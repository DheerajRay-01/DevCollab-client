  ...
  console.log(card);
    ...
    const handleUnsave = async (e) => {
      ...
      try {
        ...
        dispatch(deleteSavedData(card.post))
    ...
    const handleCardClick = () => {
      navigate(`/view/${card.repoName}/${card.post}`);
    };

    return (
      <div
        className="w-full sm:w-[320px] md:w-[350px] lg:w-[380px] bg-white shadow-md rounded-xl p-5 border border-gray-200 
